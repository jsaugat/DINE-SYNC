  ...
  try {
    ...
    if (deletedReservation) {
      ...
      if (day) {
        ...
        if (table) {
          // Set the status property of the table to "available"
...
const deleteOrderById = async (req, res, next) => {
  ...
  try {
    ...
    if (deletedReservation) {
      ...
      // Remove reservation from User model (if needed)
      // Assuming reservation is not linked to a specific user
      // If it's linked, the user-related removal logic would be here
...
export { reserveTable, getMyOrders, deleteOrder, getAllOrders, deleteOrderById };
